import { RowIterator, BoardIterator, ColumnIterator, GridIterator } from './BoardIterator';

function compileResults(iter: BoardIterator): Array<number> {
...
function testIterLength(iter: BoardIterator, skipping: boolean): void {
